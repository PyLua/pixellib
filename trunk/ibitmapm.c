/**********************************************************************
 *
 * ibitmapm.c - basic bitmap operation interface
 *
 * there are three bitmap operate for software bitmap interface:
 *
 ...
 */
int ibitmap_blit(struct IBITMAP *dst, int x, int y, struct IBITMAP *src, 
          int sx, int sy, int w, int h, unsigned long mask, int mode)
{
    long pitch1, pitch2;
    long linesize, d1, d2;
    int pixsize, r;
